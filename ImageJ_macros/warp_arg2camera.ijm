...
function warp_arg2camera(input_source, filename_source, input_target, filename_target, output_transf_folder, transf_file, output_folder) {
...
warp_arg2camera(input_source, list[i], input_target, list_target[i], output_transf_folder, list_txt[i], output_folder);
setBatchMode(false);
